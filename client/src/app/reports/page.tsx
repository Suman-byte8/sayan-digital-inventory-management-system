...
export default function ReportsPage() {
    ...
    const handleExport = () => {
        ...
        const data = activeTab === 'sales' ? salesData : inventoryData;
    ...
    return (
        <div className="flex flex-col h-full p-6 space-y-6">
            ...
            {/* Filters for Sales */}
            {activeTab === 'sales' && (
                <div className="bg-white p-4 rounded-lg border border-gray-200 flex items-end gap-4">
                    <div>
                ...
                <div className="overflow-auto flex-1">
                    <table className="w-full text-left text-sm">
                        ...
                        <tbody className="divide-y divide-gray-200">
                            {loading ? (
                            ...
                            ) : (activeTab === 'sales' ? salesData : inventoryData).length === 0 ? (
                                <tr>
                                    <td colSpan={6} className="px-6 py-8 text-center text-gray-500">
                                        No data found.
                                    </td>
                                ...
                                (activeTab === 'sales' ? salesData : inventoryData).map((item: any) => (
                                        ...
                                        {activeTab === 'sales' ? (
                                            <>
                                                ...
                                                <td className="px-6 py-4">
                                                    <span className={`inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium ${item.status === 'Completed' ? 'bg-green-100 text-green-800' :
                                            ...
                                            <>
                                                ...
                                                <td className="px-6 py-4 text-center">
                                                    <span className={`inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium ${item.inStock ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'
                                                        }`}>
